...
module.exports = async (device) => {
  ...
  await user.screenshot('Click registration to submit owners')
  await user.hover(user.stripeid, true)
  ...
  await user.hover('Submit completed', true)
  await user.screenshot('Click "Submit completed"')
  await user.hover('Submit completed', true)
  await user.click('Submit completed', true)
  await user.hover('Submit owners', true)
  await user.screenshot('Submit form')
  await user.hover('Submit owners', true)
  await user.click('Submit owners', true)

...
module.exports = async (device) => {
  ...
  await user.screenshot('Click invoice to refund')
  await user.hover(user.invoiceid, true)
  await user.click(user.invoiceid, true)
  await user.hover('Refund invoice')
  await user.screenshot('Click "Refund invoice"')
  await user.hover('Refund invoice')
  await user.click('Refund invoice')
  await user.hover('Refund invoice', true)
  await user.screenshot('Select billing profile and submit form')
  await user.hover('Refund invoice', true)
  await user.click('Refund invoice', true)

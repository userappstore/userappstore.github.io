...
module.exports = async (device) => {
  ...
  await user.clickLabel('Credit')
  await user.click('Cancel subscription', true)
  await user.home()
  user.creditid = await user.creditid()
  await user.hover('Account')
  ...
  await user.screenshot('Click "Credits"')
  await user.hover('Credits')
  await user.click('Credits')
  await user.hover(user.creditid, true)
  await user.screenshot('Click credit to refund')
  await user.hover(user.creditid, true)
  await user.click(user.creditid, true)
  await user.hover('Refund balance')
  await user.screenshot('Click "Refund balance"')
  await user.hover('Refund balance')
  await user.click('Refund balance')
  await user.hover('Refund credit', true)
  await user.screenshot('Select billing profile and submit form')
  await user.hover('Refund credit', true)
  await user.click('Refund credit', true)

...
module.exports = async (device) => {
  ...
  await user.screenshot('Click subscription to change plans for')
  await user.hover(user.subscriptionid, true)
  await user.click(user.subscriptionid, true)
  await user.hover('Change plan')
  await user.screenshot('Click "Change plan"')
  await user.hover('Change plan')
  await user.click('Change plan')
  await user.fill({ 
    planid: `silver${now}`
  })
  await user.hover('Change plan', true)
  await user.screenshot('Select new plan and submit form')
  await user.hover('Change plan', true)
  await user.click('Change plan', true)

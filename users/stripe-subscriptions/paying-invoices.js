...
module.exports = async (device) => {
  ...
  await user.screenshot('Click invoice to pay')
  await user.hover(user.invoiceid, true)
  await user.click(user.invoiceid, true)
  await user.hover('Pay invoice')
  await user.screenshot('Click "Pay invoice"')
  await user.hover('Pay invoice')
  await user.click('Pay invoice')
  await user.hover('Pay invoice', true)
  await user.screenshot('Select billing profile and submit form')
  await user.hover('Pay invoice', true)
  await user.click('Pay invoice', true)

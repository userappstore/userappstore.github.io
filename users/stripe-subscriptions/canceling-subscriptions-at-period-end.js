...
module.exports = async (device) => {
  ...
  await user.screenshot('Click subscription to cancel')
  await user.hover(user.subscriptionid, true)
  await user.click(user.subscriptionid, true)
  await user.hover('Cancel subscription')
  await user.screenshot('Click "Cancel subscription"')
  await user.hover('Cancel subscription')
  await user.click('Cancel subscription')
  await user.clickLabel('After current billing period')
  await user.hover('Cancel subscription', true)
  await user.screenshot('Select at period end and submit form')
  await user.hover('Cancel subscription', true)

...
module.exports = async (device) => {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    deleteid = deleteid || await user.stripeid()
  ...
  await owner.tab.waitFor(1000)
  await owner.hover(deleteid, true)
  await owner.screenshot('Click Stripe account to delete')
  await owner.hover(deleteid, true)
  await owner.click(deleteid, true)
  await owner.hover('Delete')
  await owner.screenshot('Click "Delete"')
  await owner.hover('Delete')
  await owner.click('Delete')
  await owner.hover('Delete', true)
  await owner.screenshot('Submit form')
  await owner.hover('Delete', true)
  await owner.click('Delete', true)

...
module.exports = async (device) => {
  ...
  await user.tab.goto(`${process.env.DASHBOARD_SERVER}/fake-amount-owed?subscriptionid=${user.subscriptionid}`, { waitLoad: true, waitNetworkIdle: true })
  await user.home()
  ...
  await owner.hover('Administrator')
  await owner.click('Stripe Subscriptions module')
  await owner.hover('Invoices')
  await owner.screenshot('Click "Charges"')
  await owner.hover('Invoices')
  await owner.click('Invoices')
  await owner.hover(user.invoiceid, true)
  await owner.screenshot('Click invoice to forgive')
  await owner.hover(user.invoiceid, true)
  await owner.click(user.invoiceid, true)
  await owner.hover('Forgive invoice')
  await owner.screenshot('Click "Forgive invoice"')
  await owner.hover('Forgive invoice')
  await owner.click('Forgive invoice')
  await owner.hover('Forgive invoice', true)
  await owner.screenshot('Submit form')
  await owner.hover('Forgive invoice', true)
  await owner.click('Forgive invoice', true)

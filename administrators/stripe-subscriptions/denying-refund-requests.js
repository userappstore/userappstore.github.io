...
module.exports = async (device) => {
  ...
  await user.click('Refund invoice')
  await user.click('Request refund')
  await user.fill({ reason: 'Accidental purchase' })
  ...
  await owner.hover('Administrator')
  await owner.click('Stripe Subscriptions module')
  await owner.hover('Refund requests')
  await owner.screenshot('Click "Refund requests"')
  await owner.hover('Refund requests')
  await owner.click('Refund requests')
  await owner.hover(user.chargeid, true)
  await owner.screenshot('Click charge to refund')
  await owner.hover(user.chargeid, true)
  await owner.click(user.chargeid, true)
  await owner.hover('Deny refund')
  await owner.screenshot('Click "Refund"')
  await owner.hover('Deny refund')
  await owner.click('Deny refund')
  await owner.fill({
    reason: 'Heavy application usage'
  })
  await owner.hover('Deny refund', true)
  await owner.screenshot('Enter amount and submit form')
  await owner.hover('Deny refund', true)
  await owner.click('Deny refund', true)

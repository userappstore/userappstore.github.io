...
module.exports = async (device) => {
  ...
  await owner.screenshot('Click "Invoices"')
  await owner.hover('Invoices')
  await owner.click('Invoices')
  await owner.hover(user.invoiceid, true)
  await owner.screenshot('Click invoice to refund')
  await owner.hover(user.invoiceid, true)
  await owner.click(user.invoiceid, true)
  await owner.hover('Refund invoice')
  await owner.screenshot('Click "Refund invoice"')
  await owner.hover('Refund invoice')
  await owner.click('Refund invoice')
  await owner.fill({
    amount: 999
  })
  await owner.hover('Refund charge', true)
  await owner.screenshot('Enter refund amount and submit form')
  await owner.hover('Refund charge', true)
  await owner.click('Refund charge', true)

...
module.exports = async (device) => {
  ...
  await owner.screenshot('Click subscription to revoke discount')
  await owner.hover(user.subscriptionid, true)
  await owner.click(user.subscriptionid, true)
  await owner.hover('Revoke coupon')
  await owner.screenshot('Click "Revoke coupon"')
  await owner.hover('Revoke coupon')
  await owner.click('Revoke coupon')
  await owner.hover('Revoke discount', true)
  await owner.screenshot('Submit form')
  await owner.hover('Revoke discount', true)
  await owner.click('Revoke discount', true)

...
module.exports = async (device) => {
  ...
  await owner.screenshot('Click subscription to delete')
  await owner.hover(user.subscriptionid, true)
  ...
  await owner.clickLabel('delay-label', true)
  await owner.hover('Delete subscription', true)
  await owner.screenshot(`Select at period end and submit form`)
  await owner.hover('Delete subscription', true)
  await owner.click('Delete subscription', true)
